...
| [`PRODUCT_BREAKDOWN_AND_ONBOARDING_PLAN.md`](./PRODUCT_BREAKDOWN_AND_ONBOARDING_PLAN.md) | Product-level contribution breakdown (DF-84) and first-time-user onboarding (ⓘ field help, sample fill) | Both implemented (PR #8). The decision lives on in `DETAILED_FEASIBILITY_DECISIONS.md` (DF-84); shipped-work record is `../HANDOFF.md` |
